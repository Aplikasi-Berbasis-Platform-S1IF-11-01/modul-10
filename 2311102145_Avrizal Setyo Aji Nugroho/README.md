...
## 1. Penjelasan `data.php` (Server-Side)

data.php berfungsi sebagai penyedia data (API) dalam format JSON agar bisa dikonsumsi oleh JavaScript.
...
## 2. Penjelasan `index.html` (Client-Side)

index.html menangani tampilan (UI) dan logika pengambilan data tanpa _reload_ halaman menggunakan AJAX.
